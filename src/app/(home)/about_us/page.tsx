    ...
    <div className="min-h-screen w-full">
      ...
      <section className="container mx-auto mt-32 h-screen md:mt-0">
        <div className="flex h-full w-full flex-col gap-20">
          ...
          {/* Main Image */}
          <div className="relative h-full w-full flex-[2] overflow-hidden rounded-3xl bg-gray-100">
            <Image src="/images/hero/bg_2.jpg" alt="Image" fill />
            <div className="absolute bottom-0 right-0 z-20 flex h-[70px] w-[310px] items-center justify-center gap-4 rounded-2xl border-[5px] border-white bg-secondary py-4">
              <div>Lebih Banyak</div>
              <ArrowUpRight />
            </div>
          </div>
